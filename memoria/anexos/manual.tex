...
Una vez levantados, el frontend estará accesible en http://localhost y Apache Hop en http://localhost:8080.
...
Todo el código fuente está disponible en el repositorio. Los administradores pueden modificar las reglas de negocio (ponderaciones del riesgo, umbrales de alerta, etc.) editando los pipelines de Hop o el código del backend, y reconstruir los contenedores con los cambios.
...
Lista completa de centros ordenados de mayor a menor índice de riesgo. Cada tarjeta muestra el nombre, tipo, número de alumnos, índice de riesgo y variación respecto al curso anterior. Al pulsar sobre una tarjeta se realiza un drill-down a la vista Micro con ese centro preseleccionado.

\subsection{Vista Micro: diagnóstico causal de un centro}

Esta vista responde a la pregunta: ¿por qué este centro tiene el riesgo que tiene? Se accede desde el menú o mediante drill-down desde la Macro.
...
\begin{enumerate}
    ...
    \item Mediante drill-down, accede a la vista Micro de esos centros.
