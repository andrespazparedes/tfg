...
\begin{figure}[htbp]
    ...
    \caption{Construcción y despliegue del frontend.}
...
El directorio \textit{src/} se organiza en módulos técnicos (ver figura \ref{fig:frontend_tree}): \textbf{services} y \textbf{api} (instancia Axios y funciones de acceso al backend), \textbf{context} (estado global de autenticación y filtros), \textbf{pages} (vistas de la SPA) y \textbf{components} (UI reutilizable).
