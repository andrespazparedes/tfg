...
Esta separación clara entre la base de datos transaccional (OLTP) y el almacén analítico (OLAP) garantiza que las complejas consultas del Dashboard no penalicen el rendimiento de las operaciones diarias de la base de datos operacional.
...
% ---- Autenticación ----
CU-01 & Iniciar sesión & Validación de credenciales, generación de token JWT y redirección al dashboard. \\
...
CU-30 & Visualizar perfil de usuario & Consultar los propios datos (nombre, email, rol) a través del endpoint \texttt{/auth/me}. \\
