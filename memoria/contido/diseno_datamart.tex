...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{imaxes/fig_datamart_erd}
    \caption{Esquema del Datamart analítico (\textit{dwh}) en modelo estrella: dos tablas de hechos de distinta granularidad (\texttt{fact\_rendimiento\_anual} y \texttt{fact\_calificaciones}) rodeadas por siete dimensiones. Se indica con \texttt{[SCD2]} la dimensión \texttt{dim\_estudiante}, que implementa una Dimensión de Variación Lenta de Tipo~2.}
