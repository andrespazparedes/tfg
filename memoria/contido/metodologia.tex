...
Para el control y la gestión del tiempo del proyecto, se ha empleado un diagrama de Gantt (ver Figura \ref{fig:gantt}), donde se detallan las distintas iteraciones de desarrollo a lo largo de los cuatro meses de duración del Trabajo de Fin de Grado.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{imaxes/planificacion_gantt.png}
